...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[430px] min-h-[100dvh] bg-white relative pb-[280px] shadow-2xl flex flex-col">
      <InstallButton />
      ...
      <div className="fixed bottom-0 w-full max-w-[430px] z-50 pointer-events-none flex flex-col justify-end">
        <div className="pointer-events-auto w-full bg-white relative z-40">
          <AdBanner />
        </div>
        <div className="pointer-events-auto w-full bg-white border-t border-gray-100 pb-safe relative z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.1)]">
